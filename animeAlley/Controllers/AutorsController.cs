...
namespace animeAlley.Controllers
{
    public class AutorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nome,date_nasc,about,foto,obras")] Autor autor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nome,date_nasc,about,foto,obras")] Autor autor)
        {
            if (id != autor.Id)
            {
                return NotFound();
