...
namespace animeAlley.Controllers
{
    public class StudiosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nome,about,status")] Studio studio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nome,about,status")] Studio studio)
        {
            if (id != studio.Id)
            {
                return NotFound();
