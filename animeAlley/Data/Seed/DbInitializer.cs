...
namespace AppFotos.Data.Seed
{
    ...
    internal class DbInitializer
    {
        ...
        internal static async void Initialize(ApplicationDbContext dbContext)
        {
            ...
            {
                utilizadores = [
                   new Utilizador { Nome="animeAlley", Foto="placeholder.png", UserName=newIdentityUsers[1].UserName, isAdmin=true, Banner="bannerplaceholder.png" },
                   new Utilizador { Nome="Daniel", Foto="placeholder.png", UserName=newIdentityUsers[0].UserName, isAdmin=false, Banner="bannerplaceholder.png" },
                  ];
